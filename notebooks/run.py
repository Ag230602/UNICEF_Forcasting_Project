...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='DFGCN')

    # basic config
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='Transformer',
                        help='model name, options: [DFGCN, iTransformer, iInformer, iReformer, iFlowformer, iFlashformer]')
    ...
    parser.add_argument('--patch_len', type=int, default=8, help='patch len')
